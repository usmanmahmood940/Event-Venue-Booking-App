...
public class Hall_Details extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
                 ...
                 getAvailableTimeSLots(new FirebaseCallBack() {
                     ...
                     public void callBack(List<TimeSlot> avTimeSlots) {
                         if(availableTimeSlots.size()>0) {
                             ...
                             bookingSlot1.setVisibility(View.GONE);
                             bookingSlot2.setVisibility(View.GONE);
                             Toast.makeText(Hall_Details.this, "No Slot Available on this date", Toast.LENGTH_SHORT).show();
                             Toast.makeText(Hall_Details.this, "Please choose different date", Toast.LENGTH_SHORT).show();
                         }
                     }
    ...
    private void bookHall(View v) {
        ...
        if(index < mealViewList.size()){
            ...
            Toast.makeText(Hall_Details.this, "Choose Menu or Without Food", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if(dateBook.trim().isEmpty()) {
            Toast.makeText(Hall_Details.this, "Booking date is required", Toast.LENGTH_SHORT).show();
        ...
        if(availableTimeSlots.size()==0){
            ...
            if(slotSelect[0].isChecked()){
                ...
                Toast.makeText(Hall_Details.this, "Choose Slot", Toast.LENGTH_SHORT).show();
                return;
            }
        }
        else{
        ...
        String requestDate = newFormat.format(c.getTime());
        Booking objBooking;
        if(bookWithoutFood){
            ...
            objBooking.setPaidStatus("UnPaid");
            objBooking.setBookingRequestDate(requestDate);
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Hall_Details.this);
        ...
        btnConfirmBooking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                saveBooking(new FirebaseCallBack() {
                    @Override
                    public void callBack() {
                        Toast.makeText(Hall_Details.this, "Hall is Booked Successfully", Toast.LENGTH_SHORT).show();
                        Hall_Details.super.onBackPressed();
    ...
    public void saveBooking(FirebaseCallBack firebaseCallBack,Booking booking){
        ...
        mRefBooking.child(bookingId).setValue(booking, new DatabaseReference.CompletionListener() {
            ...
            public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                if (error == null) {
                    AllData.saveNotification("New Booking","You have new booking of  "+ objHall.getHallName()+" Hall",booking.getUserEmail(),booking.getVendorEmail(),booking,Hall_Details.this);

                    FcmNotificationsSender notificationsSender = new FcmNotificationsSender(recieverUser.getToken(),"New Booking","You have new booking of "+ objHall.getHallName()+" Hall",getApplicationContext(),Hall_Details.this);

                    notificationsSender.SendNotifications();
                } else {
                    Toast.makeText(Hall_Details.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                }
